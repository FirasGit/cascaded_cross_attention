...
def get_dataloader(cfg, train_shuffle=True, fold=0):
    train_dataset, validation_dataset, test_dataset, collate_fn = get_dataset(cfg, fold=fold)
    ...
    train_dataloader = DataLoader(
        train_dataset, collate_fn=collate_fn, batch_size=cfg.meta.batch_size, shuffle=shuffle, num_workers=cfg.meta.num_workers, drop_last=False,
        sampler=sampler)
